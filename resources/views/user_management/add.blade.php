            ...
            <div class="card card-outline card-primary">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('user.add') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('company_branch_id') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Company Branch <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <select class="form-control role select2" style="width: 100%;" name="company_branch_id" id="company_branch_id">
