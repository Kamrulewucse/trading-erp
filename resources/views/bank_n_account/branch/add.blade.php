    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('branch.add') }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('name') }}" name="name" class="form-control" id="name" placeholder="Enter branch Name">
                                @error('name')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
