    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <form action="{{ route('bank_account.edit',['account'=>$account->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" style="width: 100%;" name="bank" id="bank">
                                    ...
                                    @foreach($banks as $bank)
                                        <option value="{{$bank->id}}" {{ old('bank',$account->bank_id) == $bank->id ? 'selected' : '' }}>{{$bank->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row {{ $errors->has('account_name') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('account_name',$account->account_name) }}" name="account_name" class="form-control" id="account_name" placeholder="Enter Account Name">
                        ...
                        <div class="form-group row {{ $errors->has('account_no') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('account_no',$account->account_no) }}" name="account_no" class="form-control" id="account_no" placeholder="Enter Account No">
                        ...
                        <div class="form-group row {{ $errors->has('account_code') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('account_code',$account->account_code ?? '') }}" name="account_code" class="form-control" id="account_code" placeholder="Enter Code">
                        ...
                        <div class="form-group row {{ $errors->has('description',$account->description ?? '') ? 'has-error' :'' }}">
                        ...
                        <div class="form-group row {{ $errors->has('opening_balance') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('opening_balance',$account->opening_balance) }}" name="opening_balance" class="form-control" id="opening_balance" placeholder="Enter Opening Balance">
