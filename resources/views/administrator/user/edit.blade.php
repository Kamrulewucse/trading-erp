                ...
                <form class="form-horizontal" method="POST" action="{{ route('user.edit', ['user' => $user->id]) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('role') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control role select2" style="width: 100%;" name="role" id="role">
                                    <option value="">Select Role Type</option>
                                    <option value="1" {{ old('role',$user->role) == 1 ? 'selected' : '' }}>Super Admin</option>
                                    <option value="2" {{ old('role',$user->role) == 2 ? 'selected' : '' }}>Warehouse</option>
                                </select>
                        ...
                        <div id="warehouse" class="form-group row {{ $errors->has('warehouse') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Warehouse <span>*</span></label>
                            <div class="col-sm-10">
                                <select class="form-control role select2" style="width: 100%;" name="warehouse">
                                    <option value="">Select Warehouse</option>
                                    @foreach($warehouses as $warehouse)
                                        <option value="{{$warehouse->id}}" {{ old('warehouse',$user->warehouse_id) == $warehouse->id ? 'selected' : '' }}>{{$warehouse->name}}</option>
                                    @endforeach
                                </select>
